...
本仓库是 BMS 后台管理系统的设计系统 Markdown 文档包，用于设计规范沉淀、前端实现对齐，以及 Cursor / Claude / Windsurf / Figma Make / Stitch 等 AI 工具协作。
...
> 注意：`Components/Block Header.md` 文件名包含空格，脚本、命令行或 AI 工具读取时需要保留完整路径，必要时使用引号包裹。
